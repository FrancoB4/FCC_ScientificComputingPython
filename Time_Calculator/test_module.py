...
class UnitTests(unittest.TestCase):
    ...
    def test_twenty_four_with_day(self):
        ...
        self.assertEqual(actual, expected,
                         'Expected calling "add_time()" with "2:59 AM", "24:00", "saturDay" to return "2:59 AM, '
                         'Sunday (next day)"')
    ...
    def test_two_days_later_with_day(self):
        ...
        self.assertEqual(actual, expected,
                         'Expected calling "add_time()" with "11:59 PM", "24:05", "Wednesday" to return "12:04 AM, '
                         'Friday (2 days later)"')
    ...
    def test_high_duration_with_day(self):
        ...
        self.assertEqual(actual, expected,
                         'Expected calling "add_time()" with "8:16 PM", "466:02", "tuesday" to return "6:18 AM, '
                         'Monday (20 days later)"')
